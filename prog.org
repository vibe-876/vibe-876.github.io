...
Whenever I encounter a problem, my mind seems to either go to "this would be easy in lisp", or "this would be easy in haskell". I find that those two complement each other very well. Maybe if I were better at prolog, I'd be able to complete the trinity of elder AI languages, but for now that stays somewhat rusty (which is another thing I need to practise more lol)...
